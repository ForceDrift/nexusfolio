    ...
    <div className="h-screen bg-background flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-card border-b border-border px-6 py-4">
          <h1 className="text-2xl font-bold text-card-foreground">Analytics</h1>
          <p className="text-muted-foreground">Deep dive into your investment data with comprehensive analytics</p>
        </header>
          ...
          <div className="border-4 border-dashed border-border rounded-lg h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-6">
                This is the Analytics page placeholder. Here you'll be able to:
              </p>
              <div className="space-y-4 max-w-md mx-auto">
                <div className="bg-card p-4 rounded-lg border border-border text-left">
                  ...
                  <ul className="text-card-foreground space-y-1 text-sm">
                    <li>• View detailed performance charts and graphs</li>
                    <li>• Analyze risk metrics and volatility</li>
                    <li>• Track historical performance trends</li>
                    <li>• Generate custom reports and insights</li>
